...
const myFunction = () => {
  ...
  console.log(tareas[0])  // Accedo a un elemento de un array con el nombre del array y entre corchetes el índice
  console.log(tareas[199])

  console.log(tareas[0].title)  // Accedo a una clave de un elemento del array
  console.log(tareas[199].title, tareas[199].id) 
  */

  console.log(usuarios.length)
  console.log(usuarios[0])
  console.log(usuarios[0].name)
  console.log(usuarios[0].company)
  console.log(usuarios[0].company.name)
...
tituloLista.innerHTML = 'id Tarea - Tarea - Estado'
const tareasLi = tareas.map((item) => {
  return `
...
listaTareas.innerHTML += tareasLi


const usersCard = usuarios.map((item) => {
  return `
     <div class="col">
        <div class="card">
          <img src="https://randomuser.me/api/portraits/women/${item.id}.jpg" class="card-img-top" alt="${item.name}">
          <div class="card-body">
            <h5 class="card-title text-primary">${item.name??'No definido'}</h5>
